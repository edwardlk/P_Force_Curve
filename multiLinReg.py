...
#			print x, "completed"
	...
	maxPos = np.argmax(positons[20:1980]) + 20
	
	upperBound = init_points[maxPos,0] - sepX/5
	lowerBound = init_points[maxPos,0] + sepX
	...
	s1, i1, r1, p1, se1 = stats.linregress(x_data[:upperBound], y_data[:upperBound])
	s2, i2, r2, p2, se2 = stats.linregress(x_data[lowerBound:], y_data[lowerBound:])
